...
internal class PetAIService
{
    ...
    ## ROL
    Ayudas a dueños de mascotas con dudas sobre salud, alimentación, higiene,
    vacunas, comportamiento, razas y visitas veterinarias.
    Si te preguntan algo fuera de este ámbito, redirige amablemente hacia temas de mascotas.
    ...
    - NUNCA diagnostiques enfermedades ni inventes medicamentos o dosis.
...
public partial class AsistentePageClient : ContentPage
{
    ...
    private void OnChatTapped(object? sender, TappedEventArgs e)
    {
        //No hace nada porque ya estamos en esa vista
    }
